                              ...
                              <div className="flex flex-wrap gap-3">
                                {ROLES.map((role) => (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={cn(
                                        "flex justify-center items-center bg-blue-900 hover:shadow-lg border-2 border-blue-300 rounded-full w-7 h-7 text-white transition-all duration-300",
                                        field.value === role &&
                                          "ring-2 ring-blue-500 ring-offset-2 "
                                      )}
                                    >
                                      {field.value === role && (
                                        <span className="bg-white rounded-full w-3 h-3" />
                                      )}
                                    </span>
